...
const Navbar = () => {
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      isActive
        ? "bg-green-500 text-white rounded px-3 py-1 font-semibold"
...
<li className="relative">
  <button
    ...
    className="font-semibold flex items-center gap-1  w-full justify-between px-3 py-1 rounded transition"
  >
    Academic
    ...
    <ul className="absolute top-full left-0 bg-white shadow-md rounded-md w-40 mt-1 py-1 z-50">
      <li>
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "bg-green-500 text-white block px-4 py-2 rounded"
              : "block px-4 py-2 hover:bg-gray-100 rounded transition"
          }
          onClick={() => setMobileMenuOpen(false)}
        >
          Students
      ...
      <div className="mx-auto px-2 md:px-auto max-w-7xl">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/login"
              className="px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded transition"
            >
              Login
            </Link>
